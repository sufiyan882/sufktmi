<?php /*Template Name: Software Company*/
...
<div class="city_category_main">
  <div class="container">
    ...
    <h1><span>Software Development Company in</span> Jaipur</h1>
     </div>
  ...
  <div class="top_left_address">
    <?php the_field('left_address');?>
      ...
      <?php the_content();?>
        ...
        <div class="ecommerce-development">
          <ul>
		...
		$rigt = get_sub_field( 'marketing_section_right' ); ?>
            <li>
              <div class="tran-sanps">
                <img src="<?php echo $markimg; ?>">
              </div>
               <div class="tran-detial">
              <?php echo $rigt; ?>
               </div>
            </li>
 <?php endwhile; endif;?>  
...
<h2><?php the_field('features_project_title'); ?></h2>
 ...
 <section class="clients">
  ...
  <div class="carousel-inner">
    <?php $zf = 0;            
    while( have_rows('testimonial_widget') ): the_row(); ?>
    <div class="carousel-item <?php if ($zf == 0) { echo 'active';} ?>">
